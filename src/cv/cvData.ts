...
export const cvLabels: Record<CvLanguage, CvLabels> = {
  vi: {
    navAria: '?i?u h??ng CV',
    brandAria: 'v? ??u trang',
    socialAria: 'Li?n h? v? m?ng x? h?i',
    emailAria: 'G?i email t?i',
    youtubeAria: 'K?nh YouTube',
    zaloAria: 'G?i Zalo',
    zaloTitle: 'G?i Zalo',
    switchLabel: 'English',
    nav: {
      ...
      projects: 'D? ?n',
      education: 'H?c v?n',
      softSkills: 'K? n?ng m?m',
    },
    sections: {
      summary: 'T?M T?T B?N TH?N',
      skills: 'K? N?NG',
      experience: 'KINH NGHI?M L?M VI?C',
      projects: 'D? ?N',
      education: 'H?C V?N',
      softSkills: 'K? N?NG M?M',
    },
